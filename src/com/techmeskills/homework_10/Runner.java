...
public class Runner {
    public static void main(String[] args) {
        ...
        BaseCard card1 = new BaseCard(153, "90190111", 1000.1);
        BaseCard card2 = new BaseCard(153, "90190111", 1000.1);
        BaseCard card3 = new BaseCard(406, "90190115", 1000.10);
        BaseCard card4 = new BaseCard(406, "90190115", 1000.20);
        BaseCard card5 = new BaseCard(406, "90190115", 1000.350);
        ...
        if (client.getBaseCards().length != 0) {
            ...
            if (count == 0) {
                System.out.println("Cards wasn't found");
            }
        }
